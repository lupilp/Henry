...
// Obtenemos el elemento con el `valor`.
...
botonInc.onclick = () => store.dispatch(incremento());
botonDec.onclick = () => store.dispatch(decremento());
botonImpar.onclick = () => store.dispatch(impar());
